...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        owner = "@760389219737796609"# ENTER YOU DISCORD-ID
        owner_name = "@mysteri0us#0602"# ENTER YOUR USERNAME#1234
        ...
        if not input:
            ...
            # emb.add_field(name="About", value=f"The Bots is developed by Chriѕ#, based on discord.py.\n\
